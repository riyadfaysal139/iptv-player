...
1. Open `IPTV-Player-1.3.1-macOS-<arch>.dmg`
...
1. Run `IPTV-Player-1.3.1-Windows-x64-Setup.exe`
...
```sh
chmod +x IPTV_Player-1.3.1-x86_64.AppImage
./IPTV_Player-1.3.1-x86_64.AppImage
```
