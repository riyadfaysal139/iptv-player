...
1. Open `IPTV-Player-1.3.0-macOS-<arch>.dmg`
...
1. Run `IPTV-Player-1.3.0-Windows-x64-Setup.exe`
...
```sh
chmod +x IPTV_Player-1.3.0-x86_64.AppImage
./IPTV_Player-1.3.0-x86_64.AppImage
```
